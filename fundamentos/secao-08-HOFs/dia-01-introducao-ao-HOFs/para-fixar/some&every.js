/* Você ficou responsável por conferir a lista de pessoas convidadas de uma festa de casamento e 
precisa verificar se o nome da pessoa está ou não na lista. 
...
const verifyAges = (arr, minimunAge) => {
  return arr.every((person) => person.age >= minimunAge)
}
